...
cat $vendor/vue-2.6.14.min.js $vendor/vue-router-3.5.3.min.js $vendor/vue-clipboard.min.js $vendor/namespace-1.0.3.min.js $vendor/tonweb-0.0.25.js $vendor/web3-1.3.5.min.js $vendor/ethers-5.0.umd.min.js > $build/js/vendor.js
